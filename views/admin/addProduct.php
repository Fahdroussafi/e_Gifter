            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-[#CC0000] overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
                <div class="flex items-center justify-center mt-8">
                    <div class="flex items-center">
                        ...
                        <span class="text-white text-2xl mx-2 font-semibold">Add Product</span>
                    </div>
                </div>
                    ...
                    <div class="mx-auto w-full max-w-[550px]">
                        <form method="POST" enctype="multipart/form-data">
                            <div class="mb-5">
                                ...
                                <input type="text" name="product_title" placeholder="Product Title" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                            <div class="mb-5">
                                <label for="Product Description" class="mb-3 block text-base font-medium text-[#07074D]">
                                    Product Description
                                </label>
                                <textarea row="5" cols="20" name="product_description" placeholder="Product Description" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                            </div>
                            <div class="mb-5">
