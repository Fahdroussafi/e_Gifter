<div class='w-full'>
    <nav class="px-2 sm:px-4 py-2.5 rounded">
        <div class="flex justify-between flex-wrap">
            <div class=""><img src="<?php echo BASE_URL; ?>./public/img/logo.png" alt="logo">
                <a href="<?php echo BASE_URL; ?>"></a>
            </div>

            <ul class="w-8/12 flex font-sans font-bold text-xl items-center text-[#FBF8F3] justify-center space-x-8 flex-wrap list-none">
            ...
            <ul class="px-2 sm:px-4 py-2.5 rounded md:px-4">
                    ...
                    <?php }
                        ...
                        <div class="dropdown dropdown-end">
                            ...
                            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow text-[#FBF8F3] bg-base-100 rounded-box w-52">
                                ...
                                <li class="text-[#FBF8F3] hover:text-[#CC0000] font-proza font-bold"><a href="<?php echo BASE_URL; ?>userorders">My Orders</a></li>
                                <li class="text-[#FBF8F3] hover:text-[#CC0000] font-proza font-bold"><a href="<?php echo BASE_URL; ?>likes">Wishlist</a></li>
                                <li class="text-[#FBF8F3] hover:text-[#CC0000] font-proza font-bold"><a href="<?php echo BASE_URL; ?>logout">Log out</a></li>
                            </ul>
                        </div>
        ...
        <div class="md:hidden flex items-center md:flex-wrap md:justify-center md:items-center">
