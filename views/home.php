...
<body>
    ...
    <section class="main">
        ...
        <div class="hero min-h-screen">
            <div class="hero-content text-[#FBF8F3] text-center">
                <div class="max-w-md text-left ">
                    ...
                    <div class="duration-500 ease-in-out hover:rotate-6 hover:scale-90">
                        <a href="<?php echo BASE_URL; ?>productslist" class="bg-[#CC0000] py-2 px-10 h-10 text-center rounded-full font-proza font-bold">SEE MORE</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="hero min-h-fit-screen bg-[#F4F5E2] py-20">
        <div class="hero-content flex-col lg:flex-row">
            ...
            <div>
                <h1 class="text-5xl font-bold ink-free text-[#080808] font-ink">Shop from Hundreds of Gift Cards</h1>
                <p class="mt-6 text-2xl text-[#080808] font-proza">The best part about our digital gift cards is that they never expire. Once you give them
                ...
                <p class="mt-4 text-2xl text-[#080808] font-proza">Get an eGift Card for a special occasion, quick shopping
    ...
    <section class="bg-green-50 py-20">
        <h1 class="text-5xl font-bold font-ink text-[#080808] text-center">Our Products</h1>
        <section class="flex gap-14 justify-center my-5 cards flex-wrap">
            <?php foreach ($products as $product) {  ?>
                <!-- loop through the products -->
                <div class="card p-6 bg-[#FBF8F3] shadow-lg hover:shadow-2xl duration-500">
                    <div>
